...
var _NavigationTransitions = class _NavigationTransitions {
  ...
  handleNavigationRequest(request) {
    ...
    (_a2 = this.transitions) == null ? void 0 : _a2.next(__spreadProps(__spreadValues(__spreadValues({}, this.transitions.value), request), {
      id
    }));
  }
          ...
          switchMap((t) => {
            ...
            if (this.urlHandlingStrategy.shouldProcessUrl(t.rawUrl)) {
              return of(t).pipe(
                ...
                switchMap((t2) => {
                  var _a3, _b2;
                  const transition = (_a3 = this.transitions) == null ? void 0 : _a3.getValue();
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-HYFOPIJH.js.map
