...
function afterRenderImpl(callbackOrSpec, injector, options, once) {
  ...
  const sequence = new AfterRenderSequence(manager.impl, getHooks(callbackOrSpec, hooks), once, destroyRef, tracing == null ? void 0 : tracing.snapshot(null));
...
var sharedMapFunction = (rEl, jsActionMap) => {
  var _a4, _b2;
  let blockName = (_a4 = rEl.getAttribute(DEFER_BLOCK_SSR_ID_ATTRIBUTE)) != null ? _a4 : "";
  const el = rEl;
...
function detachViewFromDOM(tView, lView) {
  var _a4;
  (_a4 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a4.notify(10);
    ...
    for (let i = 0; i < registry.length; i++) {
      ...
      if (isNodeMatchingSelectorList(
        ...
        if (isComponentDef(def)) {
          ...
          hostDirectiveDefs = hostDirectiveDefs || /* @__PURE__ */ new Map();
          (_a4 = def.findHostDirectiveDefs) == null ? void 0 : _a4.call(def, def, matches, hostDirectiveDefs);
          matches.push(def);
        }
      }
    }
...
var ViewRef$1 = class {
  ...
  get dirty() {
    var _a4;
    return !!(this._lView[FLAGS] & (64 | 1024 | 8192)) || !!((_a4 = this._lView[REACTIVE_TEMPLATE_CONSUMER]) == null ? void 0 : _a4.dirty);
  }
  /**
...
__publicField(ComponentFactoryResolver$1, "NULL", new _NullComponentFactoryResolver());
...
var ComponentFactory = class extends ComponentFactory$1 {
  ...
  create(injector, projectableNodes, rootSelectorOrNode, environmentInjector) {
    ...
    const prevConsumer = setActiveConsumer(null);
    try {
      if (ngDevMode && (typeof ngJitMode === "undefined" || ngJitMode) && ((_a4 = this.componentDef.debugInfo) == null ? void 0 : _a4.forbidOrphanRendering)) {
...
function mergeInputsWithTransforms(target, source) {
  ...
  for (const key in source.inputs) {
    ...
    if (source.inputTransforms !== null) {
      ...
      (_a4 = target.inputTransforms) != null ? _a4 : target.inputTransforms = {};
...
function findMatchingDehydratedViewForDeferBlock(lContainer, lDetails) {
  var _a4, _b2;
  return (_b2 = (_a4 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a4.find((view) => view.data[DEFER_BLOCK_STATE$1] === lDetails[DEFER_BLOCK_STATE])) != null ? _b2 : null;
}
...
var _ApplicationInitStatus = class _ApplicationInitStatus {
  ...
  appInits = (_a = inject(APP_INITIALIZER, {
    optional: true
  })) != null ? _a : [];
...
function triggerHydrationFromBlockName(injector, blockName, replayQueuedEventsFn) {
  return __async(this, null, function* () {
    ...
    yield (_a4 = blocksBeingHydrated.get(blockName)) == null ? void 0 : _a4.promise;
    pendingTasks.remove(taskId);
...
function clearRendererCache(factory, def) {
  var _a4;
  (_a4 = factory.rendererByCompId) == null ? void 0 : _a4.delete(def.id);
}
...
var _ChangeDetectionSchedulerImpl = class _ChangeDetectionSchedulerImpl {
  ...
  disableScheduling = (_a2 = inject(ZONELESS_SCHEDULER_DISABLED, {
    optional: true
  })) != null ? _a2 : false;
...
var _ImagePerformanceWarning = class _ImagePerformanceWarning {
  ...
  start() {
    var _a4, _b2;
    if (!this.isBrowser || typeof PerformanceObserver === "undefined" || ((_a4 = this.options) == null ? void 0 : _a4.disableImageSizeWarning) && ((_b2 = this.options) == null ? void 0 : _b2.disableImageLazyLoadWarning)) {
      return;
    }
...
function verifySsrContentsIntegrity() {
  ...
  for (const node of doc.body.childNodes) {
    if (node.nodeType === Node.COMMENT_NODE && ((_a4 = node.textContent) == null ? void 0 : _a4.trim()) === SSR_CONTENT_INTEGRITY_MARKER) {
...
function linkedSignal(optionsOrComputation, options) {
  ...
  const equal = isShorthand ? options == null ? void 0 : options.equal : optionsOrComputation.equal;
  if (equal) {
    node.equal = equal;
  }
...
function effect(effectFn, options) {
  ...
  if (useMicrotaskEffectsByDefault) {
    if (ngDevMode && (options == null ? void 0 : options.forceRoot)) {
...
function afterRenderEffect(callbackOrSpec, options) {
  ...
  const sequence = new AfterRenderEffectSequence(manager.impl, [spec.earlyRead, spec.write, spec.mixedReadWrite, spec.read], scheduler, injector.get(DestroyRef), tracing == null ? void 0 : tracing.snapshot(null));
  manager.impl.register(sequence);
  return sequence;
}
var ResourceStatus;
...
var WritableResourceImpl = class extends BaseWritableResource {
  ...
  abortInProgressLoad() {
    var _a4, _b2;
    (_a4 = this.pendingController) == null ? void 0 : _a4.abort();
    this.pendingController = void 0;
    (_b2 = this.resolvePendingTask) == null ? void 0 : _b2.call(this);
...
var _a3;
if (typeof ngDevMode !== "undefined" && ngDevMode) {
  (_a3 = _global.$localize) != null ? _a3 : _global.$localize = function() {
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-VZXDPEEY.js.map
